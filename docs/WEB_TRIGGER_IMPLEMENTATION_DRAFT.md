...
1. [`FUTURE_IDEAS_AND_IMPLEMENTATION_PLAN.md`](FUTURE_IDEAS_AND_IMPLEMENTATION_PLAN.md)
2. [`SERIAL_PROTOCOL.md`](SERIAL_PROTOCOL.md)
3. [`TROUBLESHOOTING.md`](TROUBLESHOOTING.md)
4. [`codeflows/scripts_run_playlist_code_flow.md`](codeflows/scripts_run_playlist_code_flow.md)
