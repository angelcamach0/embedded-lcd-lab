...
- [ ] Existing standalone sketches still compile:
  - [ ] [`src/playlist/03_lcd_wakeup_reveal_000030.ino`](../src/playlist/03_lcd_wakeup_reveal_000030.ino)
  - [ ] [`src/playlist/02_lcd_matrix_rain_000700.ino`](../src/playlist/02_lcd_matrix_rain_000700.ino)
  - [ ] [`src/playlist/04_lcd_city_datetime_temp_feed_000150.ino`](../src/playlist/04_lcd_city_datetime_temp_feed_000150.ino)
